...
export class DataBindingComponent {
  ...
  op: string='';
  count : number=0;
  // Calculate(num3 : any, num4 :any){
  //   this.addition =  +num3.value + +num4.value;
  //   this.multiplication = +num3.value * +num4.value;
  //   this.division = +num3.value / +num4.value;
  // }
 ...
 employees1 = [
    ...
    },
    {
      ...
      "company": {
        "name": "Deckow-Crist",
        "catchPhrase": "Proactive deIdactic contingency",
